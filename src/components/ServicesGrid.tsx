  ...
  const services = [
    {
      ...
      description: "Desenvolvemos e implementamos soluções de software sob medida, integrando perfeitamente com sua infraestrutura existente. Nossa abordagem garante máxima eficiência e produtividade.",
      features: [
    ...
    },
    {
      ...
      description: "Oferecemos treinamentos completos em tecnologias Microsoft, desde Office 365 até Azure. Nossa equipe certificada garante aprendizado eficaz e aplicação prática imediata.",
      features: [
    ...
    },
    {
      ...
      description: "Facilitamos sua jornada para a nuvem com estratégias personalizadas, garantindo segurança, escalabilidade e redução de custos operacionais significativos.",
      features: [
    ...
    },
    {
      ...
      description: "Implementamos soluções de IA para automatizar processos, analisar dados e gerar insights valiosos que impulsionam a tomada de decisões estratégicas.",
      features: [
      ...
      <div className="container mx-auto">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="flex items-start gap-4 mb-6">
                <div className={`w-16 h-16 bg-gradient-to-r ${service.color} rounded-xl flex items-center justify-center text-2xl flex-shrink-0`}>
                  {service.icon}
                </div>
          ...
          <div className="text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <div className="text-gray-500 text-sm">
                ✓ Sem compromisso • ✓ Relatório detalhado • ✓ Consultoria especializada
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="mt-16">
          ...
          <div className="grid md:grid-cols-4 gap-8">
            {[
              { step: "01", title: "Análise", desc: "Avaliação completa da sua infraestrutura atual" },
              { step: "02", title: "Estratégia", desc: "Desenvolvimento de plano personalizado" },
              { step: "03", title: "Implementação", desc: "Execução com metodologias ágeis" },
              { step: "04", title: "Suporte", desc: "Acompanhamento contínuo e otimização" }
            ].map((item, index) => (
